(custom-set-variables
 ...
 '(package-selected-packages
   '(back-button cython-mode csv-mode doom-modeline use-package doom-modeline-mode scss-mode kotlin-mode zig-mode d-mode protobuf-mode framemove some-package yaml-mode web-mode tide ron-mode flycheck-rust cargo rust-mode company-anaconda anaconda-mode lsp-ui lsp-mode json-mode js2-mode gotest go-projectile go-eldoc company-go go-mode rainbow-mode elisp-slime-nav rainbow-delimiters key-chord company counsel swiper ivy exec-path-from-shell zop-to-char oled-dark-theme which-key volatile-highlights undo-tree super-save smartrep projectile operate-on-number nlinum move-text magit imenu-anywhere hl-todo guru-mode gitignore-mode gitconfig-mode git-timemachine gist flycheck expand-region editorconfig easy-kill discover-my-major diminish diff-hl crux browse-kill-ring anzu ag ace-window))
